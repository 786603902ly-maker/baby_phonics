...
/* ---- Level 3 and 4: words she will read, not just recognise ---- */
(function () {
  'use strict';
  var I = window.ICONS;
  function num(n, colour) {
  ...
  I.cake = '<path d="M18 52h64v30a6 6 0 0 1-6 6H24a6 6 0 0 1-6-6z" fill="#E8A85C"/><path d="M18 52c6-10 14-10 16 0 2-9 10-9 16 0 2-9 10-9 16 0 2-9 10-9 16 0v10H18z" fill="#FFF4DE"/><rect x="47" y="22" width="6" height="16" rx="3" fill="#E8624A"/><path d="M50 12c4 5 5 8 0 10-5-2-4-5 0-10z" fill="#F5C518"/><g fill="#E8624A"><circle cx="32" cy="70" r="3"/><circle cx="50" cy="76" r="3"/><circle cx="68" cy="70" r="3"/></g>';
  I.bike = '<circle cx="24" cy="66" r="18" fill="none" stroke="#2E2A3B" stroke-width="6"/><circle cx="76" cy="66" r="18" fill="none" stroke="#2E2A3B" stroke-width="6"/><path d="M24 66l16-28h20l16 28M40 38l12 28M32 38h14" fill="none" stroke="#2D8FA8" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><path d="M54 34h14" stroke="#4A4A55" stroke-width="5" stroke-linecap="round"/>';
  I.bone = '<path d="M30 38a12 12 0 1 0-8 20l40 22a12 12 0 1 0 8-20z" fill="#FFF9F0" stroke="#E7DAC7" stroke-width="3"/><circle cx="22" cy="34" r="11" fill="#FFF9F0" stroke="#E7DAC7" stroke-width="3"/><circle cx="78" cy="66" r="11" fill="#FFF9F0" stroke="#E7DAC7" stroke-width="3"/><circle cx="34" cy="24" r="11" fill="#FFF9F0" stroke="#E7DAC7" stroke-width="3"/><circle cx="66" cy="76" r="11" fill="#FFF9F0" stroke="#E7DAC7" stroke-width="3"/><path d="M32 40l36 20" stroke="#FFF9F0" stroke-width="16" stroke-linecap="round"/>';
  I.gate = '<rect x="8" y="24" width="9" height="66" rx="3" fill="#8B5A2B"/><rect x="83" y="24" width="9" height="66" rx="3" fill="#8B5A2B"/><g fill="#C68642"><rect x="20" y="34" width="7" height="48" rx="3"/><rect x="34" y="34" width="7" height="48" rx="3"/><rect x="48" y="34" width="7" height="48" rx="3"/><rect x="62" y="34" width="7" height="48" rx="3"/><rect x="73" y="34" width="7" height="48" rx="3"/><rect x="18" y="40" width="64" height="8" rx="3"/><rect x="18" y="68" width="64" height="8" rx="3"/></g>';
  I.frog = '<ellipse cx="50" cy="64" rx="30" ry="22" fill="#5AA469"/><circle cx="30" cy="36" r="13" fill="#5AA469"/><circle cx="70" cy="36" r="13" fill="#5AA469"/><circle cx="30" cy="34" r="6" fill="#FFF9F0"/><circle cx="70" cy="34" r="6" fill="#FFF9F0"/><circle cx="30" cy="34" r="3" fill="#2E2A3B"/><circle cx="70" cy="34" r="3" fill="#2E2A3B"/><path d="M34 66a18 10 0 0 0 32 0" fill="none" stroke="#3F7F51" stroke-width="3.5" stroke-linecap="round"/><path d="M16 78c-8 4-8 10 0 12M84 78c8 4 8 10 0 12" fill="none" stroke="#5AA469" stroke-width="7" stroke-linecap="round"/>';
  I.clock = '<circle cx="50" cy="52" r="36" fill="#FFF9F0" stroke="#4A4A55" stroke-width="6"/><path d="M50 30v24l16 10" fill="none" stroke="#2E2A3B" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/><g fill="#4A4A55"><circle cx="50" cy="22" r="2.6"/><circle cx="80" cy="52" r="2.6"/><circle cx="50" cy="82" r="2.6"/><circle cx="20" cy="52" r="2.6"/></g>';
  I.crab = '<ellipse cx="50" cy="58" rx="28" ry="20" fill="#E8624A"/><circle cx="38" cy="50" r="5" fill="#FFF9F0"/><circle cx="62" cy="50" r="5" fill="#FFF9F0"/><circle cx="38" cy="50" r="2.6" fill="#2E2A3B"/><circle cx="62" cy="50" r="2.6" fill="#2E2A3B"/><path d="M40 66a12 6 0 0 0 20 0" fill="none" stroke="#C74A34" stroke-width="3"/><path d="M22 44c-10-6-16-2-16 6 6 0 8 4 8 8 8-2 10-8 8-14z" fill="#C74A34"/><path d="M78 44c10-6 16-2 16 6-6 0-8 4-8 8-8-2-10-8-8-14z" fill="#C74A34"/><g stroke="#C74A34" stroke-width="5" stroke-linecap="round"><path d="M26 70l-10 10M40 76l-6 12M60 76l6 12M74 70l10 10"/></g>';
  I.hand = '<path d="M34 52V22a7 7 0 0 1 14 0v26M48 48V16a7 7 0 0 1 14 0v32M62 50V26a7 7 0 0 1 14 0v40c0 14-10 24-24 24H44c-12 0-20-8-24-18l-6-14c-2-6 4-11 9-7l11 9z" fill="#F0D5B0" stroke="#D8B48A" stroke-width="3" stroke-linejoin="round"/>';
  I.thumb = '<path d="M28 44h16v44H28a6 6 0 0 1-6-6V50a6 6 0 0 1 6-6z" fill="#E8BE95"/><path d="M44 46l14-30c2-5 12-4 12 4l-4 18h18a8 8 0 0 1 8 9l-4 26c-1 7-7 12-14 12H44z" fill="#F0D5B0" stroke="#D8B48A" stroke-width="3" stroke-linejoin="round"/>';
  I.five = num(5, '#E8624A');
  I.three = num(3, '#5AA469');
  I.chair = '<rect x="24" y="14" width="12" height="76" rx="4" fill="#8B5A2B"/><rect x="24" y="20" width="46" height="10" rx="4" fill="#C68642"/><rect x="24" y="36" width="46" height="10" rx="4" fill="#C68642"/><rect x="24" y="54" width="52" height="12" rx="4" fill="#E8A85C"/><rect x="66" y="62" width="10" height="28" rx="4" fill="#8B5A2B"/>';
  I.cheese = '<path d="M10 62l44-26h36v22l-8 8H10z" fill="#F5C518"/><path d="M10 62h72v16H10z" fill="#E8A800"/><g fill="#E8A800"><circle cx="30" cy="54" r="5"/><circle cx="52" cy="46" r="4"/><circle cx="70" cy="56" r="6"/></g>';
  I.shell = '<path d="M50 84C22 84 8 62 12 42 16 24 32 14 50 14s34 10 38 28c4 20-10 42-38 42z" fill="#F0A8BC"/><g stroke="#D97D9B" stroke-width="3" fill="none"><path d="M50 14v70M28 20c-4 22-2 44 8 62M72 20c4 22 2 44-8 62M14 40c10 16 14 30 14 44M86 40c-10 16-14 30-14 44"/></g>';
  I.teeth = '<path d="M12 34h76v26c0 16-17 28-38 28S12 76 12 60z" fill="#F0A8BC"/><path d="M16 36h68v20H16z" fill="#FFFCF6"/><g stroke="#E7DAC7" stroke-width="2.5"><path d="M33 36v20M50 36v20M67 36v20M16 46h68"/></g>';
  I.book = '<path d="M12 20h32c4 0 6 3 6 6v58c0-3-2-6-6-6H12z" fill="#2D8FA8"/><path d="M88 20H56c-4 0-6 3-6 6v58c0-3 2-6 6-6h32z" fill="#4FB6D0"/><path d="M12 20h32c4 0 6 3 6 6v52H12z" fill="#E7F1FF"/><path d="M88 20H56c-4 0-6 3-6 6v52h38z" fill="#FFFCF6"/><g stroke="#B9C2CC" stroke-width="2.5"><path d="M20 36h22M20 46h22M20 56h16M58 36h22M58 46h22M58 56h16"/></g><rect x="47" y="20" width="6" height="64" rx="2" fill="#22758A"/>';
  I.mud = '<path d="M8 68c10-8 22-8 30-2 8-8 20-8 28-2 8-6 18-4 26 4v18H8z" fill="#8B5A2B"/><ellipse cx="30" cy="60" rx="8" ry="5" fill="#6B4420"/><ellipse cx="62" cy="62" rx="10" ry="6" fill="#6B4420"/><circle cx="46" cy="46" r="5" fill="#8B5A2B"/><circle cx="72" cy="40" r="4" fill="#8B5A2B"/>';
})();
